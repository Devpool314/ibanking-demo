...
public class OtpService {
    ...
    /** Tạo OTP 6 số, lưu HASH và gửi email (nếu có cấu hình). Luôn trả về OTP để DEV test. */
    public String sendOtp(Long transactionId, String email) {
        ...
        // Gửi email OTP (MailService đã tự bắt lỗi & có cờ app.mail.enabled)
        ...
        return otp; // để hiển thị trong trang verify khi DEV
    }
