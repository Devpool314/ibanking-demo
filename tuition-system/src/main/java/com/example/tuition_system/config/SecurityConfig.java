...
public class SecurityConfig {
    ...
    // Nếu bạn đã có CustomUserDetailsService là @Service, expose nó như UserDetailsService
    @Bean
    ...
    // DÙNG no-arg + setter (đúng cho Spring Security 6.x)
    @Bean
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http
            ...
            .formLogin(form -> form
                ...
                .defaultSuccessUrl("/payment/list", true)
